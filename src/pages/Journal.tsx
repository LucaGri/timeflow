    ...
    <div className="p-4 sm:p-6 md:p-8">
      <div className="mb-6 md:mb-8 pt-12 md:pt-0">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          ...
          <Button onClick={handleNewEntry} size="sm" className="self-start min-h-[44px] sm:min-h-0">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-input bg-background pl-10 pr-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
        </div>
      ...
      {filteredEntries.length === 0 ? (
        <div className="rounded-lg border bg-card p-8 sm:p-12 text-center">
          ...
          {entries.length === 0 && (
            <Button onClick={handleNewEntry} className="min-h-[44px]">
              <Plus className="mr-2 h-4 w-4" />
              Crea Prima Nota
            </Button>
          )}
        ...
        <div className="space-y-6 sm:space-y-8">
          {Object.entries(groupedEntries).map(([month, monthEntries]) => (
            <div key={month}>
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 capitalize">{month}</h2>
